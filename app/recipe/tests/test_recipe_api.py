...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Gravy')
        payload = {
            'title': 'Paneer Masala',
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='sandwich cheese')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='cheese pizza')
        recipe2 = sample_recipe(user=self.user, title='sandwich cheese')
        ...
        recipe3 = sample_recipe(user=self.user, title='mushroom soup')
